...
public class RoomController {
    ...
    //search rooms by location, capacisity, chechin and out dates (from booking service)
    ...
    public ResponseEntity<ApiResponse<List<RoomResponseDto>>> searchRooms(
        ...
        List<RoomResponseDto> rooms = service.searchRooms(location, capacity, checkInDate, checkOutDate);
        return ResponseEntity.ok(
                ApiResponse.success("Rooms searched successfully", rooms)
        );
    }
}